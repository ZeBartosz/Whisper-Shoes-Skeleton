...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnAddNew" runat="server" OnClick="btnAddNew_Click" style="z-index: 1; left: 11px; top: 302px; position: absolute; width: 148px;" Text="ADD" />
        <asp:Label ID="lblShippingAddress" runat="server" style="z-index: 1; left: 28px; top: 362px; position: absolute; width: 233px;" Text="Enter a Shipping Address"></asp:Label>
        ...
        <asp:Button ID="btnReturn" runat="server" Height="35px" OnClick="btnReturn_Click" Text="Return To Main Menu" />
        <p>
            &nbsp;</p>
        <p>
            &nbsp;</p>
