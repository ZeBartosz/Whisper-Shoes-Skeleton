...
<body style="height: 186px">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblCustomerFirstName" runat="server" style="z-index: 1; left: 6px; top: 44px; position: absolute" Text="Customer First Name"></asp:Label>
        ...
        <asp:Button ID="btnReturnMainMenu" runat="server" OnClick="btnReturnMainMenu_Click" style="z-index: 1; left: 8px; top: 276px; position: absolute; width: 136px" Text="Return to main menu" />
     </form>
</body>
